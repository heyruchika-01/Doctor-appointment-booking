...
const MyProfile = () => {
  ...
  return userData && (
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      <hr className='bg-zinc-400 h-[1px] underline mt-3' />
      <div>
      ...
      {
        isEdit ? <input className='bg-gray-100' type="date"  onChange={(e)=> setUserData(prev => ({...prev, dob: e.target.value}))} value={userData.dob}/>
